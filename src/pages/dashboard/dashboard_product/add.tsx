...
const DashboardProductAdd: React.FC<Props> = () => {
  ...
  return (
    ...
    <div className="form-group  ">
      ...
      <input type="text" className={`form-control ${errors.name ? `invalid` : ""}`} id="productName" placeholder="Enter product name" {...register("name")} />
    {errors.name &&<div className="text-danger">{errors.name?.message}</div>}
    </div>
    <div className="form-group">
      <label htmlFor="productDescription">Description</label>
      <textarea className="form-control" id="productDescription" rows={3} placeholder="Enter product description" value={"mo ta"} {...register("description")} />
    </div>
    <div className="form-group">
      <label htmlFor="productPrice">Price</label>
      <input type="number" className={`form-control ${errors.price ? `invalid` : ""}`} id="productPrice" placeholder="Enter product price" {...register("price")} />
    ...
    <div className="form-group">
      ...
      <input type="number" className={`form-control ${errors.quantity ? `invalid` : ""}`} id="productPrice" placeholder="Enter product price" {...register("quantity")} />
